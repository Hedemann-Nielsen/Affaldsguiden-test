						...
						filteredCategories.map((category) => {
							return (
								<>
									<details>
										{/* overskriften  */}
										<summary key={category.id} className={style.categoryBox}>
											<div className={style.leftAlign}>
												<img src={category.icon_url} alt={category.title} />
												<p className={globalStyle.subtitle2}>
													{category.title}
												</p>
											</div>
											<img
										...
										<div className={style.content}>
											<div>
												<p
													className={`${globalStyle.subtitle4} ${style.succes}`}>
													Ja tak
												</p>
												<hr />
												<ul>
											...
											<div>
												<p
													className={`${globalStyle.subtitle4} ${style.error}`}>
													Nej tak
												</p>
												<hr />
												<ul>
